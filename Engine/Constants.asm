...
VDP_Reg1_val =						VDP_reg_1_command		; alias from Sonic 1 (GitHub)
...
Vscroll_Factor =					V_scroll_value			; alias from Sonic 1 (GitHub)
Vscroll_Factor_FG =					V_scroll_value_FG		; alias from Sonic 1 (GitHub)
Vscroll_Factor_BG =					V_scroll_value_BG		; alias from Sonic 1 (GitHub)
