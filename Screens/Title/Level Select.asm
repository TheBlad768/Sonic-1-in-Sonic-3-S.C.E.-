...
.index
		dc.w bytes_to_word(LevelID_GHZ,ACT_1)
		dc.w bytes_to_word(LevelID_GHZ,ACT_2)
		dc.w bytes_to_word(LevelID_GHZ,ACT_3)
		dc.w bytes_to_word(LevelID_MZ,ACT_1)
		dc.w bytes_to_word(LevelID_MZ,ACT_2)
		dc.w bytes_to_word(LevelID_MZ,ACT_3)
		dc.w bytes_to_word(LevelID_SYZ,ACT_1)
		dc.w bytes_to_word(LevelID_SYZ,ACT_2)
		dc.w bytes_to_word(LevelID_SYZ,ACT_3)
		dc.w bytes_to_word(LevelID_LZ,ACT_1)
		dc.w bytes_to_word(LevelID_LZ,ACT_2)
		dc.w bytes_to_word(LevelID_LZ,ACT_3)
		dc.w bytes_to_word(LevelID_SLZ,ACT_1)
		dc.w bytes_to_word(LevelID_SLZ,ACT_2)
		dc.w bytes_to_word(LevelID_SLZ,ACT_3)
		dc.w bytes_to_word(LevelID_SBZ,ACT_1)
		dc.w bytes_to_word(LevelID_SBZ,ACT_2)
		dc.w bytes_to_word(LevelID_LZ,ACT_4)
		dc.w bytes_to_word(LevelID_SBZ,ACT_3)
