...
namespace S3KObjectDefinitions.SBZ
{
	class SwingingSpikeball : ObjectDefinition
	{
		...
		{
			imgwreckingball = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../Objects/Environ/Swinging Platform/KosinskiPlusM Art/GHZ Swinging Platform.kospm", CompressionType.KosinskiPlusM), "../../Objects/Environ/Swinging Platform/Object Data/Map - Swinging Platforms (SBZ).asm", 1, 2);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../Objects/Environ/Big Spike Ball/KosinskiPlusM Art/Large Spikeball.kospm", CompressionType.KosinskiPlusM), "../../Objects/Environ/Big Spike Ball/Object Data/Map - Big Spike Ball.asm", labels[i], i == 2 ? 2 : 0));
		}
