...
namespace S3KObjectDefinitions.SYZ
{
	class BigSpikeBall : ObjectDefinition
	{
		...
		{
			img = (ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../Objects/Environ/Big Spike Ball/KosinskiPlusM Art/Large Spikeball.kospm", CompressionType.KosinskiPlusM), "../../Objects/Environ/Big Spike Ball/Object Data/Map - Big Spike Ball.asm", 0, 0));
		}
