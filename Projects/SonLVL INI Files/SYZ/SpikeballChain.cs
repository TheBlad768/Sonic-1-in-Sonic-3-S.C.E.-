...
namespace S3KObjectDefinitions.SYZ
{
	class SpikeballChain : ObjectDefinition
	{
		...
		{
			img = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../../Objects/Environ/Spike Ball/KosinskiPlusM Art/Small Spikeball.kospm", CompressionType.KosinskiPlusM), "SYZ/Mappings/Map - Spike Ball (SYZ).asm", "Map_SpikeBall_SYZ", 0);
		}
