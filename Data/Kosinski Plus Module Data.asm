...
;		Attribute	| Filename	| Folder
		...
		incfile.ba	ArtKosPM_LargeSpikeball, "Objects/Environ/Big Spiked Ball/KosinskiPM Art/Large Spikeball.kospm"
		incfile.ba	ArtKosPM_SmallSpikeball, "Objects/Environ/Spiked Ball/KosinskiPM Art/Small Spikeball.kospm"
		incfile.ba	ArtKosPM_SpikedBallandChain, "Objects/Environ/Spiked Ball/KosinskiPM Art/Spiked Ball and Chain.kospm"
