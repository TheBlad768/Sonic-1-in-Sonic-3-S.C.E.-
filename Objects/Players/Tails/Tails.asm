...
loc_149BA:
	...
	if WaterSkimming
		...
		mvabs.w	x_vel(a0),d0							; move Tails's X-velocity to d0
		cmpi.w	#$250,d0							; if Tails speed less than $250?
		blo.s	loc_149DA							; if yes, branch
		moveq	#$F,d0
		add.w	(Water_level).w,d0
		cmp.w	y_pos(a0),d0							; is Tails slightly in the water?
		blt.s	loc_149DA							; if not, branch
