...
Obj_MovingBlock:
		...
		move.l	#Map_MovingBlockLZ,d2						; LZ specific code
...
; ---------------------------------------------------------------------------
		...
		; mappings
		include "Objects/Environ/Moving Block/Object Data/Map - Moving Block (LZ).asm"
		include "Objects/Environ/Moving Block/Object Data/Map - Moving Block (MZ and SBZ).asm"
