...
; init
ObjDat_Gargoyle:		subObjData Map_Gargoyle, $2E9, 2, FALSE, 32, 32, 3, 0, 0
ObjDat_Gargoyle_FireBall:	subObjData Map_Gargoyle, $2E9, 0, FALSE, 16, 16, 4, 2, $18|collision_flags.npc.hurt
; ---------------------------------------------------------------------------
