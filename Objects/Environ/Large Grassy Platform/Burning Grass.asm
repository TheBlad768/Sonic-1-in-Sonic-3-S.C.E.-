...
; init
ObjDat_GrassFire:		subObjData Map_LavaBall, $298, 0, FALSE, 16, 16, 1, 0, collision_type.npc.hurt, 16, 16
ObjDat3_GrassFire_Fire:		subObjData FALSE, FALSE, 0, FALSE, 16, 16, 1, 0, collision_type.npc.hurt, 16, 16
