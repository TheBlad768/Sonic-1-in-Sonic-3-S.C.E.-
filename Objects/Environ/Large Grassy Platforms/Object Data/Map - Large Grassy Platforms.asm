...
Map_LargeGrass:
		dc.w Map_LargeGrass_6-Map_LargeGrass, Map_LargeGrass_56-Map_LargeGrass
		dc.w Map_LargeGrass_94-Map_LargeGrass
Map_LargeGrass_6:	dc.b 0, $D
