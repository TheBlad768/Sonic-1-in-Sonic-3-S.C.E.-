...
; init
ObjSlot_BigRing:		subObjSlotData 1-1, ArtTile_Explosion, 1, FALSE, $40, 4, Map_BigRing, 64, 64, 5, 0, collision_type.npc.none, 0, 0
ObjSlot_BigRingFlash:		subObjSlotData 1-1, ArtTile_Player_1, 1, FALSE, $18, 6, Map_BigRingFlash, 64, 64, 4, 0, collision_type.npc.none, 0, 0
